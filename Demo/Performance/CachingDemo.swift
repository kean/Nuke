...
private final class CachingDemoModel: ObservableObject {
    ...
    init() {
        ...
        urlCachePipeline = ImagePipeline(configuration: urlCacheConfiguration, delegate: DemoDiagnostics.delegate)
        ...
        dataCachePipeline = ImagePipeline(configuration: dataCacheConfiguration, delegate: DemoDiagnostics.delegate)
    }
