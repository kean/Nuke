...
| `-demoAutorun 1` | Starts the run of a Lab screen as soon as it opens, once per launch: Scroll Stress scrolls, and Cancellation Torture runs its checks and the slot check |
