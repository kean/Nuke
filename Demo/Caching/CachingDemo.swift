...
struct CachingDemo: View {
    ...
    private static let info = DemoInfo(
        ...
        points: [
            ...
            .init("The images", "A 310 KB JPEG photo, a 173 KB WebP of a tree, and an 18 KB PNG with transparency, from user-images.githubusercontent.com and kean.github.io. The resize and the thumbnail both fit the image in 160 × 160 pt. Offline, fixtures in the same formats stand in for them.")
        ]
    )
}
