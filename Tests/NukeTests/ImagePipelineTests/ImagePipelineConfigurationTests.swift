...
struct ImagePipelineConfigurationTests {
    ...
    @Test func optionDefaults() {
        ...
        #expect(configuration.isTaskCoalescingEnabled == true)
        #expect(configuration.isRateLimiterEnabled == true)
        #expect(configuration.isProgressiveDecodingEnabled == false)
        ...
        #expect(configuration.isUsingPrepareForDisplay == true)
        #expect(configuration.isLocalResourcesSupportEnabled == true)
        #expect(configuration.isDiagnosticsEnabled == ImagePipeline.Diagnostics.isEnabledByEnvironment)
#if os(macOS)
        #expect(configuration.isDecompressionEnabled == false)
#else
        #expect(configuration.isDecompressionEnabled == true)
#endif
    }
