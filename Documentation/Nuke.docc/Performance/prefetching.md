...
This code sample comes straight from the demo app in the [repo](https://github.com/kean/Nuke/tree/main/Demo), which also has a SwiftUI version of the same screen.
