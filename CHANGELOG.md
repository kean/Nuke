...
- Remove the rate limiter. `ImagePipeline/Configuration-swift.struct/isRateLimiterEnabled` is deprecated and no longer does anything – https://github.com/kean/Nuke/pull/960
