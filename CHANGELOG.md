...
- Fix `LazyImage` using the `pipeline`, `onStart`, `onCompletion` and `transaction` values from its first appearance for requests started by a view update – https://github.com/kean/Nuke/pull/1017
